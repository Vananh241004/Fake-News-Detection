...
#     model_file_id = "1JrRAZfMchV7dSp_lo44lArgAHbCt9zrf"  # Thay bằng Google Drive file ID của bạn
#     tokenizer_file_id = "1-pAXhFjXYgqZEA5ce8zVRyKU6msoxFVC"  # Thay bằng Google Drive file ID của tokenizer
